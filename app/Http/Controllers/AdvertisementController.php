...
class AdvertisementController extends Controller
{
    ...
    public function index()
    {
        if(auth()->user()->role == 3){
            ...
            return view('advertisement.index', ['advertisementList' => Advertisement::orderBy('id','desc')->get(), 'active_menu' => 'advertisement']);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        $coaching_id = 0;
        if($request->coaching_id != ''){
            $coaching_id = $request->coaching_id;
        }
        $advertisement->coaching_id 	  = $coaching_id;
    ...
    public function edit(Advertisement $advertisement)
    {
        ...
        if(auth()->user()->role == 3){
            $coachingList = [];
            $coachingId = auth()->user()->id;    
            if($advertisement->coaching_id != $coachingId){
