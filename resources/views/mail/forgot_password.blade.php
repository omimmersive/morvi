<!DOCTYPE html>
	<head>
		...
		<title>ERx Emailer || Forget Password</title>
								...
								<table border="0" style="margin:0; width:100%" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td class="content" style="padding:40px 40px;">
											...
											<p style="color:#FFFFFF; border-radius:3px; font-family:'Poppins', sans-serif; margin:30px 0; background-color:transparent; border:2px dashed #ec297b; padding:14px; font-size:14px; text-align:left; display:block;"> 
											...
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff;">If any Questions? Please send us an email at <a href="javascript:void(0);" style="color:#ec297b !important">indo@erxcounsel.app</a> and we will revert as soon as possible.</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; margin-top:20px; margin-bottom:0;">Best Regards</p>
											<p style="font-family:'Poppins', sans-serif; font-size:15px; color:#fff; font-weight:600; margin-top:5px">ERxcounsel Team</p>
										</td>
									</tr>
								</table>
							</td>
